...
API_ID = getenv('TELEGRAM_API_ID', '32169320')
API_HASH = getenv('TELEGRAM_API_HASH', '283073ccf29ecf3ba0f249806b42be34')
BOT_TOKEN = getenv('TELEGRAM_BOT_TOKEN', '8494179560:AAEbQxEOOU3jsm6uEi8gwPddY5A7wmzALFI')
CHANNEL_LOGS = getenv('TELEGRAM_CHANNEL_LOGS', '-1003459093517')
...
async def user_ban(client: Client, m: Message):
    ...
    with Database() as db:
        ...
        # 𝙍𝙚𝙖𝙨𝙤𝙣 -» <code>Mantenimiento by @DarkFlux4T</code>
        #        """
        #             )
